...
func (_m *MockUserProvider) User(ctx context.Context, email string) (model.User, error) {
...
func (_c *MockUserProvider_User_Call) RunAndReturn(run func(context.Context, string) (model.User, error)) *MockUserProvider_User_Call {
	_c.Call.Return(run)
	return _c
}
